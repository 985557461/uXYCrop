...
public class CropImageView extends TransformImageView {
     ...
     * {@link com.yalantis.ucrop.view.CropImageView.WrapCropBoundsRunnable} which animates image.
     ...
     * or when certain conditions inside {@link com.yalantis.ucrop.view.CropImageView.WrapCropBoundsRunnable#run()} method are triggered.
     */
    private static class WrapCropBoundsRunnable implements Runnable {
        ...
        public WrapCropBoundsRunnable(CropImageView cropImageView,
            ...
            mCropImageView = new WeakReference<CropImageView>(cropImageView);
     ...
     * Given values are interpolated during the animation time.
     * Runnable can be terminated either vie {@link #cancelAllAnimations()} method
     * or when certain conditions inside {@link com.yalantis.ucrop.view.CropImageView.ZoomImageToPosition#run()} method are triggered.
     */
